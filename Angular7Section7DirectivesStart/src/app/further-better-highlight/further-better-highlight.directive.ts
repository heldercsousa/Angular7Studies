...
@Directive({
  selector: '[appFurtherBetterHighlight]'
})
export class FurtherBetterHighlightDirective implements OnInit {

  @Input() defaultColor: string='transparent';
  @Input('appFurtherBetterHighlight') highlightColor: string='blue';

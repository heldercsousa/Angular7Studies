...
@NgModule({
  ...
  imports: [
    ...
    RecipesModule // make this RecipesModule available in AppModule
  ],
  providers: [// it makes sure all app has the same RecipeService instance, avoiding instantiating it more than once
    ShoppingListService,
    RecipeService,
    {
